...
struct dailyList_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            ...
            dailyList(type :  NutrientType(id:"002", name:"Fibra", icon: "leaf.fill", color: .green, mesurementType: "g"))
                .environment(\.managedObjectContext, PersistenceController.preview.container.viewContext)
            dailyList(type : NutrientType(id:"003", name:"Proteïnes", icon: "allergens", color: .pink, mesurementType: "mL"))
                .environment(\.managedObjectContext, PersistenceController.preview.container.viewContext)
        }
